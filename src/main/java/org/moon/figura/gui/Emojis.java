...
public class Emojis {
    ...
    public static Component convertEmoji(String string, Style style) {
        emoji: {
            ...
            if (emoji != null) {
                newText.append(new TextComponent(emoji).withStyle(STYLE.withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new TextComponent(prefix + pos[0] + suffix).withStyle(style)))));
