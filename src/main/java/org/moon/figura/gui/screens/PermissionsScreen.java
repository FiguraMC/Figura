...
public class PermissionsScreen extends AbstractPanelScreen {
    ...
    protected void init() {
        ...
        //back button
        addRenderableWidget(back = new Button(middle + 6 + bottomButtonsWidth, height - 24, bottomButtonsWidth, 20, new FiguraText("gui.done"), null,
        ...
        yoink = new Button(middle + listWidth - 18, back.y - 24, 20, 20, new TextComponent("yoink"), new TextComponent("Set the selected player's avatar"), button -> {
