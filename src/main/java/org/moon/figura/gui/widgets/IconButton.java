...
public class IconButton extends Button {
    ...
    public IconButton(int x, int y, int width, int height, int u, int v, int regionSize, ResourceLocation texture, int textureWidth, int textureHeight, Component text, Component tooltip, net.minecraft.client.gui.components.Button.OnPress pressAction) {
