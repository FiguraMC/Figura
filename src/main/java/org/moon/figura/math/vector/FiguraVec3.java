...
public class FiguraVec3 extends FiguraVector<FiguraVec3> implements CachedType<FiguraVec3> {
    ...
    @LuaWhitelist
    public static boolean __lt(@LuaNotNil FiguraVec3 l, @LuaNotNil FiguraVec3 r) {
        return l.x < r.x && l.y < r.y && l.z < r.z;
    }

    @LuaWhitelist
    public static boolean __le(@LuaNotNil FiguraVec3 l, @LuaNotNil FiguraVec3 r) {
        return l.x <= r.x && l.y <= r.y && l.z <= r.z;
    }
    ...
    public static void reset(@LuaNotNil FiguraVec3 vec) {
        vec.reset();
    }
    ...
    public static void set(@LuaNotNil FiguraVec3 vec, Double x, Double y, Double z) {
        if (x == null) x = 0d;
        if (y == null) y = 0d;
        if (z == null) z = 0d;
        vec.set(x, y, z);
    ...
    public static FiguraVec3 copy(@LuaNotNil FiguraVec3 vec) {
        return vec.copy();
    }
    ...
    public static void normalize(@LuaNotNil FiguraVec3 vec) {
        vec.normalize();
    }
    ...
    public static FiguraVec3 normalized(@LuaNotNil FiguraVec3 vec) {
