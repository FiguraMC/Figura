...
public class EntityTask extends RenderTask {
    ...
    public void setNbt(String nbt) {
        try {
            ...
            assert Minecraft.getInstance().level != null;
            entity = EntityType.loadEntityRecursive(b, Minecraft.getInstance().level, Function.identity());
            if (entity == null) {
    ...
    public void updateWalkingDistance(float distance) {
    ...
    public void setHeadRotation(FiguraVec2 vec2) {
        if(entity != null && entity instanceof LivingEntity living) {
