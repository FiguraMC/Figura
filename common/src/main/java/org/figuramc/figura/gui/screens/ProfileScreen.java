...
public class ProfileScreen extends AbstractPanelScreen {
    ...
    public void init() {
        ...
        this.addRenderableWidget(new Button(width / 2 - 30, height / 2 - 30, 60, 20, new TextComponent("meow"),
            ...
            FiguraToast.sendToast(new TextComponent("Backend restarting").setStyle(Style.EMPTY.withColor(TextColor.fromRgb(0x99BBEE))), "in 10 minutes!", FiguraToast.ToastType.DEFAULT);
        }));
